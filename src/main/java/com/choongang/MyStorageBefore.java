...
//        int select = -1;
//        do {
//            select = getValidNumber(s, "[System] 원하는 기능의 번호를 입력하세요 : ");
...
//        }
    ...
    public static void prod_amount_add(Scanner s) {
        ...
        int cnt = getValidNumber(s, "[System] 추가할 수량을 입력해주세요 : ");
        counts[foundIdx] += cnt;
...
//        }
        ...
        int cnt = getValidNumber(s, "[System] 원하는 출고량을 입력하세요 : ");
        if(cnt > counts[foundIdx]) {
            System.out.println("[Error] 남은 수량보다 더 많이 출고할 수 없습니다.");
            return;
        }
